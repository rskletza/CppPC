...
TEST_F(VectorTest, VectorReverse)
{
  ...
  LOG_MESSAGE("VectorTest.VectorReverse: vector__reverse(empty vector)");
  v = vector__reverse(v);
  ASSERT_EQ(0,   vector__size(v));
  ...
  LOG_MESSAGE("VectorTest.VectorReverse: vector__reverse(...)");
  v = vector__reverse(v);
  ASSERT_EQ(4,   vector__size(v));
  ASSERT_EQ(444, vector__at(v, 0));
  ASSERT_EQ(333, vector__at(v, 1));
  ASSERT_EQ(222, vector__at(v, 2));
  ASSERT_EQ(111, vector__at(v, 3));
